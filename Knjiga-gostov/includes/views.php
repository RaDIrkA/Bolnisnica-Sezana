...
$DISPLAY_TIME_ZONE = "";
$PREVIOUS_TEXT = "< Prejšnji";
$NEXT_TEXT = "Naslednji >";
$DISPLAY_EMAIL_FIELD = TRUE;
$DISPLAY_URL_FIELD = FALSE;
$DISPLAY_COMMENT_FIELD = TRUE;
$CREDIT_LINK_REMOVAL_LICENSE = FALSE;
$ADDED_TEXT = "Vaše besedilo je bilo dodano";
$PENDING_TEXT = "Vaše besedilo je na čakanju za odobritev";
...
<textarea name="comments" id="comments" cols="40" rows="7 class="inputTextArea">
