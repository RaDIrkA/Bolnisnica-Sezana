               ...
               function getTipueSearch(start, replace)
               {
                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         if (c != 0)
                         {
                              ...
                              if (c == 1)
                              {
                                   out += '<div id="tipue_search_results_count">1 : Rezultat iskanja</div>';
                              }
                              else
                              {
                                   c_c = c.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
                                   out += '<div id="tipue_search_results_count">' + c_c + ': Rezultat iskanja</div>';
                              }
                              ...
                              if (c > set.show)
                              {
                                   ...
                                   if (start > 0)
                                   {
                                       out += '<li><a href="javascript:void(0)" class="tipue_search_foot_box" id="' + (start - set.show) + '_' + replace + '">&#171; Nazaj</a></li>'; 
                                   }
                                   ...
                                   if (page + 1 != pages)
                                   {
                                       out += '<li><a href="javascript:void(0)" class="tipue_search_foot_box" id="' + (start + set.show) + '_' + replace + '">Naslednja &#187;</a></li>'; 
                                   }                    
                         ...
                         {
                              out += '<div id="tipue_search_warning_head">Nobena vsebina ne ustreza vašemu iskanju.</div>'; 
                         }
                    }
                    else
                    {
                         if (show_stop)
                         {
                              out += '<div id="tipue_search_warning_head">Ni rezultatov iskanja</div><div id="tipue_search_warning">Pogoste besede so v večini al pa v veliki meri prezrte</div>';     
                         }
                         else
                         {
                              out += '<div id="tipue_search_warning_head">Vnesili ste prekratko besedilo</div>';
                              if (set.minimumLength == 1)
                              {
                                   out += '<div id="tipue_search_warning">Vpišite en znak ali več</div>';
                              }
                              else
                              {
                                   out += '<div id="tipue_search_warning">Vpišite ' + set.minimumLength + ' znake ali več</div>';
                              }
                         }
                    }
